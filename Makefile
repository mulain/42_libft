...
#    Updated: 2023/02/12 14:58:52 by wmardin          ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC =	$(addprefix $(PATH_ft_is)/, ft_isalnum.c ft_isalpha.c ft_isascii.c ft_isdigit.c ft_isprint.c)\
		...
		$(addprefix $(PATH_mulain)/, append_char.c append_string.c del_singlechar.c free_2d_char.c get_precedingnode.c is_intsize.c is_numberformat.c print_list_str.c count_occurences.c is_onlydigits.c)
