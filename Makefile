...
#    Updated: 2022/12/20 21:32:01 by wmardin          ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC =	$(addprefix $(PATH_ft_is)/, ft_isalnum.c ft_isalpha.c ft_isascii.c ft_isdigit.c ft_isprint.c)\
		...
		$(addprefix $(PATH_mulain)/, append_char.c append_string.c del_singlechar.c free_2d_char.c is_intsize.c is_numberformat.c print_list_str.c)
