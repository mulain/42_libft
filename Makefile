...
#    Updated: 2023/02/13 20:02:52 by wmardin          ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC =	$(addprefix $(PATH_ft_is)/, ft_isalnum.c ft_isalpha.c ft_isascii.c ft_isdigit.c ft_isprint.c)\
		...
		$(addprefix $(PATH_mulain)/, append_char.c append_string.c count_occurences.c count_subelements.c del_singlechar.c free_2d_char.c get_precedingnode.c is_intsize.c is_numberformat.c is_onlydigits.c print_list_str.c)
